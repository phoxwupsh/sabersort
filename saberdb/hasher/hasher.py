...
from imagehash import ImageHash, average_hash, hex_to_flathash, phash, phash_simple, dhash, whash, colorhash, crop_resistant_hash
...
class Hasher():
    ...
    def hash(self, img: Image.Image | str) -> ImageHash | None:
